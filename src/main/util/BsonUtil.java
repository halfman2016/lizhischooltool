...
public class BsonUtil {
    ...
    /**
     * 此方法type:{$regex:'Report'}废弃
     * 改用 type:{$regex:'Report'}
     *
     * find 模糊查询
     *  例子：{type:'/Report/',writer:{$in:['何蕾','万']},delFlag:'0',date:{$gte: '2000-12-12 00:00:00',$lte: '2017-03-30 00:00:00'}}
     * 表：Report
     * @param bsonString 字符串
     * @param key    type
     * @param value  Report
     ...
     */
    @Deprecated
    public static BasicDBObject getBasicDBObject(String bsonString, String key, String value){
        BasicDBObject bd = (BasicDBObject) JSON.parse(bsonString);
        Pattern queryPattern = Pattern.compile(value, Pattern.CASE_INSENSITIVE);
        bd.replace(key, queryPattern);
        return bd;
    }
